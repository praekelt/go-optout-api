How to contribute to Go Opt Outs API
====================================

Go Opt Outs API is an Open Source software project under the BSD
...
2.  Run the tests, we'll only accept pull requests with passing tests.
    Ensure that the tests run with ``trial go_optouts`` and that
